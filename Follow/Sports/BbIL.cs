...
{
    public class BbIL : Basic.BasicBaseball
    {
        //private int diffTime;//時間差
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Baseball_IL, "Url1");
        public BbIL(DateTime today)
            : base(ESport.Baseball_IL)
        {
            // 設定
            this.AllianceID = 73;
            this.GameType = "BB3AIL";
            ...
            {
                this.sWebUrl = @"http://www.milb.com/lookup/json/named.schedule_vw_complete.bam?game_date='{0}'&season={1}&league_id=117";
            }
