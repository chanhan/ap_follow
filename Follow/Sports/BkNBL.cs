...
{
    public class BkNBL : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_NBL, "Url1");
        public BkNBL(DateTime today) : base(ESport.Basketball_NBL)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "australia", " nbl", 10);
            // 判斷資料
