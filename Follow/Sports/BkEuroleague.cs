...
{
    public class BkEuroleague : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_Euroleague, "Url1");
        public BkEuroleague(DateTime today) : base(ESport.Basketball_Euroleague)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "europe", " euroleague", 10);
            // 判斷資料
