...
{
    public class BkFIBA : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_FIBA, "Url1");
        public BkFIBA(DateTime today) : base(ESport.Basketball_FIBA)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "asia", " asia championship", 10);
            // 判斷資料
