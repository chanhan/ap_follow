...
{
    public class BkBBL : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_BBL, "Url1");
        public BkBBL(DateTime today)
            : base(ESport.Basketball_BBL)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "germany", " bbl", 10);
            // 判斷資料
