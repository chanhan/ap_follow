...
{
    public class BkVTB : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_VTB, "Url1");
        public BkVTB(DateTime today) : base(ESport.Basketball_VTB)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "europe", " vtb", 10);
            // 判斷資料
