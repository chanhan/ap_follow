...
{
    public class BkNBA1 : Basic.BasicBasketball
    {
        public BkNBA1(DateTime today) : base(ESport.Football_NFL)
        {
            // 設定
            this.AllianceID = 1;
            this.GameType = "BKUS";
            ...
            this.DownWeb.Tag = @"http://www.cbssports.com/nba/scoreboard";
        }
        ...
        private List<List<string>> FollowByWebTeamBoard(string webID, bool isReFun = true)
        {
            ...
            catch // 錯誤，這可能是因為尚未加入 Script
            {
                ...
                // AwayBoard
                ele.SetAttribute("type", @"text/javascript");
                ele.SetAttribute("text", @"function " + funAwayBoard + "(){return g[" + webID + "][17] + ',' + g[" + webID + "][14];}");
                // 加入
                this.DownWeb.Document.Body.AppendChild(ele);
                ...
                // 設定
                ele.SetAttribute("type", @"text/javascript");
                ele.SetAttribute("text", @"function " + funHomeBoard + "(){return g[" + webID + "][18] + ',' + g[" + webID + "][15];}");
                // 加入
                this.DownWeb.Document.Body.AppendChild(ele);
                #endregion
