...
{
    public class BbNPB2 : Basic.BasicBaseball
    {
        public BbNPB2(DateTime today)
            : base(ESport.Baseball_NPB2)
        {
            // 設定
            this.AllianceID = 46;
            this.GameType = "BBJP";
            ...
            {
                this.sWebUrl = @"http://www.playsport.cc/livescore.php?aid=2&gamedate={0:yyyyMMdd}&mode=11";
            }
            // 運彩 Url 參數: aid=2 (賽事種類: 日本職棒) gamedate (時間: yyyyMMdd) mode=11 (盤口: 國際)
