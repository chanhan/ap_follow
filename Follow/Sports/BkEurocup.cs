...
{
    public class BkEurocup : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_Eurocup, "Url1");
        public BkEurocup(DateTime today) : base(ESport.Basketball_Eurocup)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "europe", " eurocup", 10);
            // 判斷資料
