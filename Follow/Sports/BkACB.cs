...
{
    public class BkACB : Basic.BasicBasketball
    {
        private string sWebUrl1 = UrlSetting.GetUrl(ESport.Basketball_ACB, "Url1");
        public BkACB(DateTime today) : base(ESport.Basketball_ACB)
        {
        ...
        public override int Follow()
        {
            ...
            int result = 0;
            // 取得資料
            Dictionary<string, BasicInfo> gameData = this.GetDataByAsiaScore(this.DownHome.Data, "spain", " acb", 10);
            // 判斷資料
